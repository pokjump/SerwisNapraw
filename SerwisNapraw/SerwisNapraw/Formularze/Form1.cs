...
namespace SerwisNapraw
{
	public partial class Form1 : Form
	{
		...
		private KontrolerGlownegoOkna kontroler;

		public Form1()
		{
			InitializeComponent();
			kontroler = new KontrolerGlownegoOkna(serwis);
		...
		private void OdswiezListe()
		{
			...
			foreach (var n in kontroler.PobierzAktywne())
			{
		...
		{
			if (kontroler.CzySaAktywneNaprawy(lstNaprawy.Items.Count))
			{
